...
<html>
    ...
    <body>
        <nav class="navbar">
            ...
            <div id="mainSection">
                <div id="profileSection">  <!-- ye left side me jaha humara data hai uski class hai -->
                    <center><img src="../uploads/<?php echo $data['photo']?>" height="150" width="150"></center><br>
                    <b>Name : </b><?php echo $data['name'] ?><br><br>
                    <b>Mobile : </b><?php echo $data['mobile'] ?><br><br>
                    <b>Address : </b><?php echo $data['address'] ?><br><br>
                    <b>Status : </b><?php echo $status ?>
                </div>
                <div id="groupSection">     <!-- ye right side me jaha humara data hai uski class hai -->
                    <?php
                    ...
                    if(isset($_SESSION['groups'])){
                        ...
                        for($i=0; $i<count($groups); $i++){
                            ?>
                                ...
                                <img style="float: right" src="../uploads/<?php echo $groups[$i]['photo']?>" height="90" width="150">
